...
export const sampleProducts: Product[] = [
  ...
  { id: '5', name: 'Sapphire Huggie', price: 40, categorySlug: 'earrings', subcategorySlug: 'hoops', colourSlug: 'blue', description: 'Sapphire-set huggies in polished sterling silver.', accentColor: '#2E6DA4', image: null, visible: true, soldOut: false, sortOrder: 5 },
