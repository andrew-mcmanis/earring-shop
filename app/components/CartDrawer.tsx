                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="cursor-pointer text-ink-light hover:text-kraft transition-colors duration-150 p-1 -m-1 rounded focus:outline-none focus:ring-2 focus:ring-kraft flex-shrink-0"
                    >
