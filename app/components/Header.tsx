          ...
          <div className="flex items-center justify-between h-28">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="absolute top-0.5 right-0.5 bg-kraft text-cream text-xs rounded-full h-4 w-4 flex items-center justify-center font-body font-semibold leading-none">
                  0
                </span>
              </button>
